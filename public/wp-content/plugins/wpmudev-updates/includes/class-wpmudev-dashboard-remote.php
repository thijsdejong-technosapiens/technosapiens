...
class WPMUDEV_Dashboard_Remote {
	 ...
	 * @return bool
	 */
	public function validate_nonce( // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		$id,
		$json
	) {
		// Validation.
		...
		// Not validating nonce anymore, as its only timestamp based, which can be easily generated by an attacker, render it useless.
		// Moreover, this gonna be problematic if attacker set the request timestamp to be far in the future. Means legit requests can be blocked, as the comparator is only `>`.
		return true;
	}

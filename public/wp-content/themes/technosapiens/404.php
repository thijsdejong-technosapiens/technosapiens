...
<main id="ts-main">
    ...
    <div class="container">
        ...
        <?php if ($staticBlock404Page && $staticBlock404Content): ?>
            <div class="row">
                <div class="col col--1">
        ...
        <?php else: ?>
            ...
            <div class="row error404__content">

                <div class="col col--1 col--lg-1/2 error404__left">

                    <h1 class="error404__heading h2">
                        <?php _e("Page not found", Theme::TEXT_DOMAIN); ?>
                    </h1>

                    <p class="error404__description">
                        <?php _e("The page you tried to visit does (not longer) exist. Go back to the previous page or use the button below to get back on track.", Theme::TEXT_DOMAIN); ?>
                    </p>

                    <?php echo ButtonComponent::render([
                        'href' => Link::getHomePageUrl(),
                        'text' => __("Take me home", Theme::TEXT_DOMAIN),
                        'blockClass' => 'error404',
                        'type' => 'primary',
                        'style' => 'filled',
                        'size' => 'large'
                ...
                <div class="col col--1 col--lg-1/2 error404__right">

                    <svg xmlns="http://www.w3.org/2000/svg" class="error404__icon" viewBox="0 0 1120.59226 777.91584"
                         aria-labelledby="title desc">
                        <title id="title">
                            <?php _e('Illustration of a lost webpage', Theme::TEXT_DOMAIN); ?>
                        </title>
                        <desc id="desc">
                            <?php _e('A graphic representing a lost webpage, featuring abstract shapes.', Theme::TEXT_DOMAIN); ?>
                        </desc>
                        <circle cx="212.59226" cy="103" r="64" fill="var(--ts-color-secondary, purple)"/>
                        <path
                        ...
                        <path
                            ...
                            fill="var(--ts-color-primary, blue)"/>
                        <path
